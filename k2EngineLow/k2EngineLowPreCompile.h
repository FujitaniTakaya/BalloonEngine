...
inline constexpr UINT FRAME_BUFFER_W = 1920;	// フレームバッファの幅。
inline constexpr UINT FRAME_BUFFER_H = 1080;	// フレームバッファの高さ。
inline constexpr UINT UI_SPACE_WIDTH = 1920;	// UI空間の幅。
inline constexpr UINT UI_SPACE_HEIGHT = 1080;	// UI空間の高さ。
inline constexpr int MAX_BONE = 512;	// ボーンの最大数。
